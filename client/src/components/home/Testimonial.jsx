...
const Testimonial = () => {
     ...
     const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">AI-powered resume builder is a beautiful and very helpful website , thans for such kind of content.</p>
        </div>
    );
...
<Title title="Don't just take our words" description="Hear what our uses say about us. We're always looking for ways to improve. If you have a positiv experience with us, leave a review." />
