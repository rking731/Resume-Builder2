    ...
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <div className='flex gap-4'>
          ...
          border-slate-300 group hover:border-purple-500 transition-all duration-300 hover:shadow-lg cursor-pointer'>
            ...
            <p className='text-sm group-hover:text-purple-500 transition-all duration-300'>Create Resume</p>
          </button>
          <button onClick={()=> setShowUploadResume(true)} className='w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg text-slate-600 border border-dashed
          border-slate-300 group hover:border-indigo-500 transition-all duration-300 hover:shadow-lg cursor-pointer'>
            ...
            <p className='text-sm group-hover:text-indigo-500 transition-all duration-300'>Upload Existing</p>
          </button>
        </div>
      ...
      {showCreateResume && (
        <form onSubmit={createResume} onClick={()=> setShowCreateResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
             <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounde-lg w-full max-w-sm p-6 '>
             ...
             <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounde-lg w-full max-w-sm p-6 '>
              ...
              <div>
                <label htmlFor="resume-input" className='block text-sm text-slate-700'>
                  Select resume file
                  <div className='flex flex-col items-center justify-center gap-2 border group text-slate-400 border-dashed rounded-md p-4 py-10 my-4 hover:border-green-500
